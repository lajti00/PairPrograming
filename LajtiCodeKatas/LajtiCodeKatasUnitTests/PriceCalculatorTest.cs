...
namespace LajtiCodeKatasUnitTests
{
    class PriceCalculatorTest
    {
        ...
        {
            var priceCalc = new PriceCalculator();
            priceCalc.Push("Beans", "can", 0.65);
            priceCalc.Push("Bread", "loaf", 0.80);
            priceCalc.Push("Milk", "bottle", 1.30);
            priceCalc.Push("Apple", "bag", 1);
        ...
        public void IfIPushAnItemToPriceCalcWhichIsAlreadyPushedThePushReturnWithExeption()
        {
            ...
            priceCalc.Push("Milk", "bottle", 1.30);
            priceCalc.Push("Apple", "bag", 1);
            Assert.Throws<InvalidOperationException>(() => priceCalc.Push("Apple", "bag", 2));
        }
        [Test]
        ...
        public void IfWeUseThePercentageOfferThePriceOfTheDeffinedItemWillChange()
        {
            ...
            priceCalc.Push("Apple", "bag", 1);
            priceCalc.ListItems();
            priceCalc.PercentageOffer(startDate, endDate, "Apple", 10);
